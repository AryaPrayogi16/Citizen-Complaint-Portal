...
<ul class="nav nav-tabs" id="filter-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request|'status' == 'delivered' ? 'active' : '' }}" href="{{ url() ->curent() }}?status=delivered" id="dikirim-tab" role="tab"> Terkirim 
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request|'status' == 'in_process' ? 'active' : '' }}" href="{{ url() ->curent() }}?status=in_process" id="diproses-tab" role="tab"> Diproses
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request|'status' == 'completed' ? 'active' : '' }}" href="{{ url() ->curent() }}?status=completed" id="selesai-tab" role="tab"> Selesai
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link {{ request|'status' == 'rejected' ? 'active' : '' }}" href="{{ url() ->curent() }}?status=rejected" id="ditolak-tab" role="tab"> Ditolak 
        </a>
    </li>
</ul>
